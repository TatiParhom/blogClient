...
const api = await $fetch(`http://panel.e436b3cc88eb.vps.myjino.ru/api/posts/${id}?populate=*`);
const post = api.data;
...
async function views() {
    const response = await $fetch(`http://panel.e436b3cc88eb.vps.myjino.ru/api/posts/${id}`, {
        method: "PUT",
        body: {
            data: {
